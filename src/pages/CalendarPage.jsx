        ...
        <div className="max-w-7xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <Button onClick={handleExportMonth} size="sm" variant="outline" className="flex items-center gap-2">
                        <Download size={16} />
                        <span className="hidden xs:inline">Export Month</span>
                    </Button>
            ...
            <div className="bg-bg-panel border border-white/5 rounded-xl overflow-hidden shadow-sm overflow-x-auto">
